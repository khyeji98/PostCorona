...
extension Store: DocumentSerializable {
    init?(dictionary: [String : Any]) {
        ...
        self.init(storeName: storeName, add1: add1, add2: add2, add3: add3, roadAdd1: roadAdd1, roadAdd2: roadAdd2, email: email, category: category, phone1: phone1, phone2: phone2, storeNum: storeNum, url: url, relief: relief, x: x, y: y)
    }
}
