...
//        locationCheck()
    ...
    @IBAction func filterCategory(_ sender: UIButton) {
        ...
        categoryView.frame = CGRect(origin: CGPoint(x: 0, y: 0), size: CGSize(width: self.view.frame.width, height: 249))
        setPopup(categoryAfterOK)
...
//        if distanceArray[indexPath.row] >= 1000 {
//            cell.distanceLabel.text = "\(floor(Double((distanceArray[indexPath.row]/1000))))km"
//        } else {
